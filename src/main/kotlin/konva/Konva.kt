...
external open class Node(config: NodeConfig) {
    ...
    open fun findAncestor(selector: String? = definedExternally /* null */, includeSelf: Boolean? = definedExternally /* null */, stopNode: Node? = definedExternally /* null */): Node /* this */ = definedExternally
    open fun findAncestors(selector: String? = definedExternally /* null */, includeSelf: Boolean? = definedExternally /* null */, stopNode: Node? = definedExternally /* null */): Array<Node> = definedExternally
    open fun fire(eventType: String, evt: Any? = definedExternally /* null */, bubble: Boolean? = definedExternally /* null */): Node /* this */ = definedExternally
...
external open class Container(params: ContainerConfig? = definedExternally /* null */) : Node {
...
external open class Shape(ShapeConfig: ShapeConfig) : Node {
    ...
    open fun fillLinearGradientColorStops(colors: Array<dynamic /* String | Number */>): Shape /* this */ = definedExternally
    ...
    open fun fillRadialGradientColorStops(color: Array<dynamic /* String | Number */>): Shape /* this */ = definedExternally
...
external open class Stage(StageConfig: StageConfig) : Container {
...
external open class FastLayer(config: LayerConfig? = definedExternally /* null */) : Container {
    open fun drawScene(): Unit = definedExternally
    open fun hitGraphEnabled(`val`: Boolean): FastLayer /* this */ = definedExternally
    open fun batchDraw(): Unit = definedExternally
}
external open class Layer(config: LayerConfig? = definedExternally /* null */) : Container {
    open fun getIntersection(pos: Vector2d, selector: String? = definedExternally /* null */): Shape = definedExternally
...
external open class Group : Container
external interface CanvasConfig {
    var width: Number
    var height: Number
    var pixelRatio: Number
}
external open class Canvas(CanvasConfig: CanvasConfig) {
...
external open class Context {
    ...
    open fun arc(x: Number, y: Number, radius: Number, startAngle: Number, endAngle: Number, anticlockwise: Boolean? = definedExternally /* null */): Unit = definedExternally
    open fun beginPath(): Unit = definedExternally
    open fun bezierCurveTo(cp1x: Number, cp1y: Number, cp2x: Number, cp2y: Number, x: Number, y: Number): Unit = definedExternally
    ...
    open fun createImageData(imageDataOrSw: Number, sh: Number? = definedExternally /* null */): ImageData = definedExternally
    open fun createImageData(imageDataOrSw: ImageData, sh: Number? = definedExternally /* null */): ImageData = definedExternally
    ...
    open fun createRadialGradient(x0: Number, y0: Number, r0: Number, x1: Number, y1: Number, r1: Number): CanvasGradient = definedExternally
    ...
    open fun drawImage(image: HTMLImageElement, dstX: Number, dstY: Number, dstW: Number, dstH: Number): Unit = definedExternally
    open fun drawImage(image: HTMLCanvasElement, dstX: Number, dstY: Number, dstW: Number, dstH: Number): Unit = definedExternally
    open fun drawImage(image: HTMLVideoElement, dstX: Number, dstY: Number, dstW: Number, dstH: Number): Unit = definedExternally
    open fun drawImage(image: ImageBitmap, dstX: Number, dstY: Number, dstW: Number, dstH: Number): Unit = definedExternally
    open fun drawImage(image: HTMLImageElement, srcX: Number, srcY: Number, srcW: Number, srcH: Number, dstX: Number, dstY: Number, dstW: Number, dstH: Number): Unit = definedExternally
    open fun drawImage(image: HTMLCanvasElement, srcX: Number, srcY: Number, srcW: Number, srcH: Number, dstX: Number, dstY: Number, dstW: Number, dstH: Number): Unit = definedExternally
    open fun drawImage(image: HTMLVideoElement, srcX: Number, srcY: Number, srcW: Number, srcH: Number, dstX: Number, dstY: Number, dstW: Number, dstH: Number): Unit = definedExternally
    open fun drawImage(image: ImageBitmap, srcX: Number, srcY: Number, srcW: Number, srcH: Number, dstX: Number, dstY: Number, dstW: Number, dstH: Number): Unit = definedExternally
    ...
    open fun setTransform(m11: Number, m12: Number, m21: Number, m22: Number, dx: Number, dy: Number): Unit = definedExternally
    ...
    open fun transform(m11: Number, m12: Number, m21: Number, m22: Number, dx: Number, dy: Number): Unit = definedExternally
    open fun translate(x: Number, y: Number): Unit = definedExternally
}
external open class Tween(params: Any) {
    open fun destroy(): Unit = definedExternally
...
external open class Ring(RingConfig: RingConfig) : Shape {
...
external open class Arc(ArcConfig: ArcConfig) : Shape {
...
external open class Circle(CircleConfig: CircleConfig) : Shape {
...
external open class Ellipse(EllipseConfig: EllipseConfig) : Shape {
...
external open class Image(ImageConfig: ImageConfig) : Shape {
...
external open class Line(LineConfig: LineConfig) : Shape {
...
external open class Arrow(ArrowConfig: ArrowConfig) : Shape {
    open fun closed(): Boolean = definedExternally
...
external open class Rect(RectConfig: RectConfig) : Shape {
...
external open class Sprite(SpriteConfig: SpriteConfig) : Shape {
...
external open class Text(TextConfig: TextConfig) : Shape {
...
external open class Wedge(WedgeConfig: WedgeConfig) : Shape {
    open fun angle(): Number = definedExternally
...
external open class Tag(config: TagConfig) : Shape {
...
external open class Label(LabelInterface: LabelInterface) : Group {
...
external open class Path(PathConfig: PathConfig) : Shape {
...
external open class RegularPolygon(RegularPolygonConfig: RegularPolygonConfig) : Shape {
...
external open class Star(StarConfig: StarConfig) : Shape {
...
external open class TextPath(TextPathConfig: TextPathConfig) : Shape {
    open fun getTextWidth(): Number = definedExternally
    open fun getTextHeight(): Number = definedExternally
...
external open class Collection {
    @nativeGetter
...
external open class Transformer(config: TransformerConfig? = definedExternally /* null */) : Container {
